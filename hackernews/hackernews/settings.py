...
Updated after the upgrade to Django 3.2.6
...
SECRET_KEY = '+&=@x$l2tnp8m77ukxf1@yq%ads*kkq&h=z3qgz6%71^316@rw'
...
# python manage.py showmigrations links
# python manage.py sqlmigrate links $migration_name
...
GRAPHENE = {
    'MIDDLEWARE': [
        # misconfigured in the tutorial, see https://github.com/flavors/django-graphql-jwt
